...
if (!mysqli_num_rows($result_son)) {
    tool::skip('index.php', '子版块不存在', 'error');
}
...
<div id="main" class="auto">
    <div id="left">
        ...
        <ul class="postsList">
            ...
            where la_content.module_id = {$data_son['id']} 
